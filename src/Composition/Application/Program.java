...
public class Program {
    ...
    public static void main(String[] args) throws ParseException { // Adicionando throws ParseException

        Locale.setDefault(Locale.US);
        Scanner sc = new Scanner(System.in);
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy"); // Criando um formatador de data
